...
if mode == "Webcam (Live)":
    ...
    st.warning("Note: If the video freezes, please check your internet connection or firewall.")

    # ⚠️ KEY UPDATE: 'sts-final-auto-v5'
    # ❌ REMOVED: 'rtc_configuration' parameter.
    # ✅ RESULT: Streamlit Cloud will now inject its own Global TURN Servers automatically.
    
    ctx = webrtc_streamer(
        key="sts-final-auto-v5",
        mode=WebRtcMode.SENDRECV,
        video_processor_factory=VideoProcessor,
        # No rtc_configuration here -> Uses Default Streamlit TURN Servers
