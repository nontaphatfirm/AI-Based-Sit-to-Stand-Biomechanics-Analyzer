...
if mode == "Webcam (Live)":
    ...
    st.info("💡 Instructions: Click 'START'. If it fails on PC, try using Mobile Hotspot.")

    # ⚠️ Robust STUN Configuration for Strict Networks
    ...
    if uploaded_file is not None:
        ...
        if not cap.isOpened(): st.error("Error: Could not open video file.")
        else:
